...
public class UtilObject {
    ...
    /**
     * 数据数组转换为对象Long数组 convert long array to Long array
     *
     * @param source
     * @return
     */
    ...
    /**
     * 对象数组转换为数据数组 convert Long array to long array
     *
     * @param source
     * @return
     */
    ...
    /**
     * 把对象数组改为数字数组 convert Integer array to int array
     *
     * @param source
     * @return
     */
    ...
    /**
     * 第一个对象和第二个对象对比 大返回1 小返回-1 等于等于零 compare two object
     * <ul>
